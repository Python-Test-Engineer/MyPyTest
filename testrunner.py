...
console.print("[cyan]Get all tests[/cyan]")
console.print("[cyan]Run all tests and save results[/cyan]")
...
console.print("[cyan]Cet CLI arguments for read from config file[/cyan]")
console.print("[cyan]Get all tests[/cyan]")
console.print("[cyan]Run all tests and save results[/cyan]")
console.print("[cyan]Display results[/cyan]")
print("")
